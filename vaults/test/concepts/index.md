...
* **claude-opus-4-7.md** - Key features and capabilities of the Claude Opus 4.7 model.
* **software-engineering-capability.md** - Claude's advanced coding and software development skills.
* **multimodal-understanding.md** - Claude's ability to process and understand multiple data types.
* **project-glasswing.md** - Information about a specific Anthropic project or initiative.
* **benchmark-evaluations.md** - Methods and results of AI model performance testing.
* **gdpval-aa-benchmark.md** - Specific benchmark test for AI capabilities.
* **instruction-following.md** - Claude's ability to understand and execute complex instructions.
* **safety-alignment.md** - Principles and methods for keeping AI systems safe and aligned.
* **effort-control.md** - Mechanisms for managing Claude's computational resource usage.
* **task-budgets.md** - System for allocating computational effort to different tasks.
* **slash-commands.md** - Quick command shortcuts for activating specific Claude features.
* **auto-mode.md** - Feature allowing Claude to operate with autonomous task decomposition.
* **tokenizer-updates.md** - Improvements to Claude's text processing and tokenization system.
* **token-usage.md** - Documentation on how Claude consumes and manages tokens.
* **prompt-injection.md** - Security considerations and defenses against prompt manipulation.
* **next-generation-compute-partnership.md** - Collaborative initiatives for advanced AI computing.
* **claude-ai-assistant.md** - General concept of Claude as an AI assistant platform.
