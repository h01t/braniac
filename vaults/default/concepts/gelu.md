...
**Source Context**: Introduced in the 2016 paper "Gaussian Error Linear Units (GELUs)" by Hendrycks and Gimpel. It was subsequently adopted as the default activation function in the BERT model (Devlin et al., 2018) and GPT architectures (Radford et al., 2018, 2019).
