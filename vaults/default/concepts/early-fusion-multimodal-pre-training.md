...
The report emphasizes that early exposure to both modalities is crucial for developing unified multimodal representations. This method is a core component of the native multimodal pre-training proposal in the Kimi K2.5 model [[entities/kimi-k2-5-model.md]].
